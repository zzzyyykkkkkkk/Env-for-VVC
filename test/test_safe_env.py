...
# === 载入已训练模型 ===
model = PPO.load(r"../安全强化学习数据_IEEE123/Bowl_5.13/ppo_model2.zip")
...
# 带控制的仿真函数
# ----------------------------------------------------------------------------------
def run_simulation_with_control(env: Safe_PowerNetEnv_IEEE123
...
if __name__ == "__main__":
    ...
    # ——— 保存 ———
    save_dir = r"../安全强化学习数据_IEEE123/测试数据2012_5_1-5.13_model2"
