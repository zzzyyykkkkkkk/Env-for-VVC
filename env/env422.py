...
class PowerNetEnv_IEEE123(gym.Env):
    ...
    def _build_state(self) -> np.ndarray:
        ...
        try:
            ...
            # 状态向量拼接
            state = np.concatenate((vm_pu, active_power, reactive_power, pv_active_power, pv_reactive_power, svc_reactive_power, soc_list))
            return state
    ...
    def _get_obs(self) -> Dict:
        ...
        try:
            ...
            active_power = safe_array(self.activate_power_data, self.year, self.month, self.day, self.current_time, 0.85)
            reactive_power = safe_array(self.reactivate_power_data, self.year, self.month, self.day,self.current_time, 0.85)
